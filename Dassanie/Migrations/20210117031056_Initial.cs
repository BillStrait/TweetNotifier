        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TwitterFollowId = table.Column<int>(type: "int", nullable: false),
                    ...
                    IncludeLink = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TwitterFollows", x => x.TwitterFollowId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TwitterOAuthToken = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    TwitterOAuthSecret = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    AlertWordId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AlertWord", x => x.AlertWordId);
                    table.ForeignKey(
                        name: "FK_AlertWord_Alerts_AlertId",
                        column: x => x.AlertId,
